...
module AdventOfCode
  module Days
    class December01 < Day
      ...
      #
      # @return [Int<484>] the sum of all given frequency changes
      ...
      # @param  [Hash<Int, Nil>] freqs the table of frequencies that `freq` is being appended to
      # @param  [Int]            freq  the frequency to start the table on
      #
      # @return [Int<367>] the first frequency that is already contained in `freqs`
